...
const fuck = [
    'No, no, no dont abuse. ',
    'hawwwww. Did you mean by my longest finger.',  
...
const siri = [
    'Siri is Apple s personal assistant for iOS, macOS, tvOS and watchOS devices',
    'It uses voice recognition and is powered by artificial intelligence'
    ...
    // 'dont want to talk about that shitty siri',
...
const favourite = [
    ...
    'Bhagat Singh - My all time favourite'
];
...
const joke = [
    ...
    'What do you call a fish with no eyes.... ummmm A fsh. hehehe '
...
const skill = [
    ...
    'Skills like what everything is a skill .  ask something specific',
...
const question = [
    'Tell me something amazing about you ',
    ...
    'how old are you',
    'if you get a chance to slap me or hug me . What will you do'
];
